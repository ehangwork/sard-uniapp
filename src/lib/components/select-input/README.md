...
@code('${DEMO_PATH}/select-input/demo/Basic.vue')
...
@code('${DEMO_PATH}/select-input/demo/Custom.vue')

### 多选

默认选择的选项的标签最多 10 会显示在输入框，其余通过 `+<rest>` 的形式展示。可以通过 `max-labels` 属性设置最多展示的标签数。

@code('${DEMO_PATH}/select-input/demo/Multiple.vue')
...
@code('${DEMO_PATH}/select-input/demo/Remote.vue')
